...
for channel = 1:nChannels
    ...
    lower_level_table = channel_table(ismember(channel_table.("Stimulation Amplitude"), unique_titration_levels{channel}),:);
    median_lower_stimulation(channel) = median(lower_level_table.("Stimulation Amplitude"));
    ...
    if numel(amp_ticks) < 2
        ...
        aux_table = epochs_power_in_bands(ismember(epochs_power_in_bands.("Stimulation Amplitude"), amp_ticks), :);
